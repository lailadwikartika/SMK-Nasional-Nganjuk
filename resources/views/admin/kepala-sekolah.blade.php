        ...
        <section class="section">
            <div class="row">
                ...
                <div class="col-lg-12 mb-3">
                    <a href="{{ route('kepala-sekolah.create') }}" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        @forelse($data as $kepala)
                                        <tr>
                                            <td>{{ $kepala->nama }}</td>
                                            <td>{{ $kepala->nip_nuptk }}</td>
                                            <td>{{ $kepala->jenis_kelamin }}</td>
                                            <td>{{ $kepala->tanggal_lahir }}</td>
                                            <td>
                                                @if ($kepala->foto)
                                                <img src="{{ asset('storage/' . $kepala->foto) }}" alt="Foto"
                                            ...
                                            <td>
                                                    <a href="{{ route('kepala-sekolah.edit', $kepala->id_kepala_sekolah) }}"
                                                        class="btn btn-sm btn-warning me-1 mb-1"><i class="bi bi-pencil-square"></i> Edit</a>
                                                    <form id="delete-form-{{ $kepala->id_kepala_sekolah }}" action="{{ route('kepala-sekolah.destroy', $kepala->id_kepala_sekolah) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete({id: '{{ $kepala->id_kepala_sekolah }}', title: 'Hapus Data Kepala Sekolah?', name: '{{ $kepala->nama }}', type: 'data'})">
