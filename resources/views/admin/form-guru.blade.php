                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- FORM CREATE --}}
                            <form action="{{ route('guru.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="mata_pelajaran" name="mata_pelajaran"
                                            ...
                                            value="{{ old('mata_pelajaran') }}" placeholder="Masukkan Mata Pelajaran">
                                ...
                                <div class="row mb-3">
                                    <label for="foto" class="col-sm-3 col-form-label">Foto (jpg, jpeg, png, webp)</label>
                                    <div class="col-sm-9">
