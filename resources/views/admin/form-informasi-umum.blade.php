                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('informasi-umum.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    <label for="visi" class="col-sm-3 col-form-label">Visi</label>
                                    <div class="col-sm-9">
                                        <textarea id="visi" name="visi" class="form-control @error('visi') is-invalid @enderror" style="height: 100px">{{ old('visi') }}</textarea>
                                        @error('visi')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea id="misi" name="misi" class="form-control @error('misi') is-invalid @enderror" style="height: 150px" placeholder="Gunakan baris baru untuk setiap poin misi">{{ old('misi') }}</textarea>
                                        @error('misi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea id="sejarah" name="sejarah" class="form-control @error('sejarah') is-invalid @enderror" style="height: 200px">{{ old('sejarah') }}</textarea>
                                        @error('sejarah')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
