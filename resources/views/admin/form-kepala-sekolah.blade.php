...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Formulir Data Kepala Sekolah</h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('kepala-sekolah.store') }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="nip_nuptk" name="nip_nuptk"
                                            ...
                                            value="{{ old('nip_nuptk') }}" placeholder="Masukkan NIP/NUPTK (maksimal 18 digit angka)"
                                ...
                                <div class="row mb-3">
                                    <label for="foto" class="col-sm-3 col-form-label">Foto (jpg, jpeg, png,
                                        webp)</label>
                                    <div class="col-sm-9">
                                        <input class="form-control @error('foto') is-invalid @enderror" type="file"
                                            id="foto" name="foto" accept=".jpg,.jpeg,.png,.webp">
                                        @error('foto')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea id="sambutan" name="sambutan"
                                            ...
                                            rows="5" placeholder="Masukkan sambutan kepala sekolah">{{ old('sambutan') }}</textarea>
                                        @error('sambutan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
