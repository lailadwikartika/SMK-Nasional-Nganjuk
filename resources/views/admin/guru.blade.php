                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $guru->tanggal_lahir ? \Carbon\Carbon::parse($guru->tanggal_lahir)->translatedFormat('d M Y') : '-' }}</td>
                                            <td>{{ $guru->tanggal_masuk ? \Carbon\Carbon::parse($guru->tanggal_masuk)->translatedFormat('d M Y') : '-' }}</td>
                                            <td>
                                                @if ($guru->foto)
                                            ...
                                            <td>
                                                    ...
                                                    <form id="delete-form-{{ $guru->id_guru }}" action="{{ route('guru.destroy', $guru->id_guru) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete({id: '{{ $guru->id_guru }}', title: 'Hapus Data Guru?', name: '{{ $guru->nama }}', type: 'guru'})">
