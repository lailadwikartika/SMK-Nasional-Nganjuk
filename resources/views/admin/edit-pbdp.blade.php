        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Jalur PPDB</h5>

                            <form action="{{ route('pbdp.update', $pbdp->id_pbdp) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="nama_jalur" name="nama_jalur"
                                            ...
                                            value="{{ old('nama_jalur', $pbdp->nama_jalur) }}" placeholder="Masukkan nama jalur">
                                        @error('nama_jalur')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" id="tanggal_buka" name="tanggal_buka"
                                            ...
                                            value="{{ old('tanggal_buka', $pbdp->tanggal_buka ? \Carbon\Carbon::parse($pbdp->tanggal_buka)->format('Y-m-d') : '') }}">
                                        @error('tanggal_buka')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" id="tanggal_tutup" name="tanggal_tutup"
                                            ...
                                            value="{{ old('tanggal_tutup', $pbdp->tanggal_tutup ? \Carbon\Carbon::parse($pbdp->tanggal_tutup)->format('Y-m-d') : '') }}">
                                        @error('tanggal_tutup')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea id="persyaratan_khusus" name="persyaratan_khusus" class="form-control @error('persyaratan_khusus') is-invalid @enderror" rows="4" placeholder="Masukkan persyaratan khusus jalur pendaftaran">{{ old('persyaratan_khusus', $pbdp->persyaratan_khusus) }}</textarea>
