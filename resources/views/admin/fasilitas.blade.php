                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <a href="{{ route('fasilitas.edit', $fasilitas->id_fasilitas) }}"
                                                        class="btn btn-sm btn-warning me-1 mb-1"><i class="bi bi-pencil-square"></i> Edit</a>
                                                    <form id="delete-form-{{ $fasilitas->id_fasilitas }}" action="{{ route('fasilitas.destroy', $fasilitas->id_fasilitas) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete({id: '{{ $fasilitas->id_fasilitas }}', title: 'Hapus Fasilitas?', name: '{{ $fasilitas->nama_fasilitas }}', type: 'fasilitas'})">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="6" class="text-center">Belum ada data Fasilitas</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
