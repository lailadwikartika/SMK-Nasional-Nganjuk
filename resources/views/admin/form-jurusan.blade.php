                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- FORM CREATE --}}
                            <form action="{{ route('jurusan.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="kode_jurusan" name="kode_jurusan"
                                            ...
                                            value="{{ old('kode_jurusan') }}" placeholder="Masukkan kode jurusan">
                                        @error('kode_jurusan')
