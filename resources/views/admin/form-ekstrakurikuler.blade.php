...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Formulir Ekstrakurikuler</h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Tambah Ekstrakurikuler</h5>

                            {{-- FORM CREATE --}}
                            <form action="{{ route('ekstrakurikuler.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf

                                <div class="row mb-3">
                                    <label for="nama_ekstrakurikuler" class="col-sm-3 col-form-label">Nama Ekstrakurikuler</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="nama_ekstrakurikuler" name="nama_ekstrakurikuler"
                                            ...
                                            value="{{ old('nama_ekstrakurikuler') }}" placeholder="Masukkan nama ekstrakurikuler">
