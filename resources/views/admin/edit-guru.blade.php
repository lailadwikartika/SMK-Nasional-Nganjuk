                            ...
                            <form action="{{ route('guru.update', $guru->id_guru) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        @if ($guru->foto)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $guru->foto) }}" alt="Foto Lama"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" id="tanggal_lahir" name="tanggal_lahir"
                                            ...
                                            value="{{ old('tanggal_lahir', $guru->tanggal_lahir ? $guru->tanggal_lahir : '') }}">
                                        @error('tanggal_lahir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" id="tanggal_masuk" name="tanggal_masuk"
                                            ...
                                            value="{{ old('tanggal_masuk', $guru->tanggal_masuk ? $guru->tanggal_masuk : '') }}">
                                        @error('tanggal_masuk')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
