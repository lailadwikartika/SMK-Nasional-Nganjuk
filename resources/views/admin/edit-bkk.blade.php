        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Form Edit Berita BKK</h5>

                            <!-- Form -->
                            <form action="{{ route('bkk.update', $bkk->id_bkk) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label for="judul_lowongan" class="form-label">Judul Lowongan</label>
                                    <input type="text" class="form-control @error('judul_lowongan') is-invalid @enderror" id="judul_lowongan" name="judul_lowongan" value="{{ old('judul_lowongan', $bkk->judul_lowongan) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_perusahaan') is-invalid @enderror" id="nama_perusahaan" name="nama_perusahaan" value="{{ old('nama_perusahaan', $bkk->nama_perusahaan) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('persyaratan') is-invalid @enderror" id="persyaratan" name="persyaratan" rows="5" required>{{ old('persyaratan', $bkk->persyaratan) }}</textarea>
                                    @error('persyaratan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_dibuka') is-invalid @enderror" id="tanggal_dibuka" name="tanggal_dibuka" value="{{ old('tanggal_dibuka', $bkk->tanggal_dibuka) }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_ditutup') is-invalid @enderror" id="tanggal_ditutup" name="tanggal_ditutup" value="{{ old('tanggal_ditutup', $bkk->tanggal_ditutup) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($bkk->foto)
                                        <img src="{{ asset('storage/' . $bkk->foto) }}" alt="Foto saat ini" class="d-block mb-2 rounded" width="150">
                                    @endif
