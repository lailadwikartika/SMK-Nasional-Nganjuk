...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('assets/logobaru.png') }}" rel="icon">    <meta charset="utf-8">
    <meta content="width=device-width, initial-scale=1.0" name="viewport">  
    <title>Admin SMK Nasional Nganjuk</title>
    <meta content="" name="description">
    <meta content="" name="keywords">   
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <form id="delete-form-{{ $jurusan->id_jurusan }}" action="{{ route('jurusan.destroy', $jurusan->id_jurusan) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete({id: '{{ $jurusan->id_jurusan }}', title: 'Hapus Jurusan?', name: '{{ $jurusan->nama_jurusan }}', type: 'jurusan'})">
