                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table datatable">
                                    <thead>
                                        <tr>
                                            <th><b>Nama Ekstrakurikuler</b></th>
                                            <th>Keterangan</th>
                                            <th>Foto</th>
                                    ...
                                    <tbody>
                                        @forelse($data as $ekstrakurikuler)
                                        <tr>
                                            <td>{{ $ekstrakurikuler->nama_ekstrakurikuler }}</td>
                                            <td>{{ $ekstrakurikuler->keterangan }}</td>
                                            <td>
                                                @if ($ekstrakurikuler->foto)
                                                <img src="{{ asset('storage/' . $ekstrakurikuler->foto) }}" alt="Foto"
                                            ...
                                            <td>
                                                    ...
                                                    <form id="delete-form-{{ $ekstrakurikuler->id_ekstrakurikuler }}" action="{{ route('ekstrakurikuler.destroy', $ekstrakurikuler->id_ekstrakurikuler) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete({id: '{{ $ekstrakurikuler->id_ekstrakurikuler }}', title: 'Hapus Ekstrakurikuler?', name: '{{ $ekstrakurikuler->nama_ekstrakurikuler }}', type: 'ekstrakurikuler'})">
