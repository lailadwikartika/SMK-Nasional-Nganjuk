...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('kepala-sekolah.index') }}">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('kepala-sekolah.index') }}">Kepala Sekolah</a></li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('kepala-sekolah.update', $kepala->id_kepala_sekolah) }}" method="POST"
                                enctype="multipart/form-data" novalidate>
                                @csrf
                                @method('PUT')

                                <div class="row mb-3">
                                    <label for="nama" class="col-sm-3 col-form-label">Nama Kepala Sekolah</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="nama" name="nama"
                                            class="form-control @error('nama') is-invalid @enderror"
                                            value="{{ old('nama', $kepala->nama) }}">
                                        @error('nama')
                                ...
                                <div class="row mb-3">
                                    <label for="nip_nuptk" class="col-sm-3 col-form-label">NIP / NUPTK</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="nip_nuptk" name="nip_nuptk"
                                            class="form-control @error('nip_nuptk') is-invalid @enderror"
                                            value="{{ old('nip_nuptk', $kepala->nip_nuptk) }}"
                                            maxlength="18" pattern="[0-9]*" required
                                            oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        <small class="form-text text-muted">NIP/NUPTK hanya boleh berisi angka, maksimal 18 digit</small>
                                        @error('nip_nuptk')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        @if ($kepala->foto)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $kepala->foto) }}" alt="Foto Kepala Sekolah"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" id="tanggal_lahir" name="tanggal_lahir"
                                            ...
                                            value="{{ old('tanggal_lahir', $kepala->tanggal_lahir ? $kepala->tanggal_lahir : '') }}">
                                        @error('tanggal_lahir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-9">
                                        <select id="jenis_kelamin" name="jenis_kelamin"
                                            ...
                                            <option value="Laki-laki"
                                                {{ old('jenis_kelamin', $kepala->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}>
                                                Laki-laki</option>
                                            <option value="Perempuan"
                                                {{ old('jenis_kelamin', $kepala->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
                                        @error('jenis_kelamin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="row mb-3">
                                    <label for="sambutan" class="col-sm-3 col-form-label">Sambutan</label>
                                    <div class="col-sm-9">
                                        <textarea id="sambutan" name="sambutan"
                                            class="form-control @error('sambutan') is-invalid @enderror"
                                            rows="5">{{ old('sambutan', $kepala->sambutan) }}</textarea>
                                        @error('sambutan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
