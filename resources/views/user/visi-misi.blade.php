...
<main class="main">
  <!-- Hero Section -->
    ...
    <section class="page-title-dark">
        <div class="container">
            <h1>Visi & Misi</h1>
            <p>Arah dan tujuan pendidikan SMK Nasional Nganjuk</p>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-11">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-6">
                            <div class="visi-card">
                                <div class="visi-icon-wrapper">
                                    <i class="bi bi-bullseye"></i>
                                </div>
                                <h2 class="fw-bold mb-3 text-white">VISI</h2>
                                <p class="fs-5 m-0">
                        ...
                        <div class="col-lg-6">
                            <div class="misi-card">
                                <div class="misi-icon-wrapper">
                                    <i class="bi bi-check-circle-fill"></i>
                                </div>
                                <h2 class="text-center fw-bold mb-4" style="color: var(--heading-color);">MISI</h2>
                                <ul class="misi-list">
                                    @php
                                        $misiItems = isset($data->misi) ? explode("\n", str_replace("\r", "", $data->misi)) : [];
                                    @endphp
                                    @forelse($misiItems as $index => $item)
                                        @if(trim($item) != "")
                                        <li>
                                        ...
                                        @endif
                                    @empty
                                        <li><span>Belum ada data misi.</span></li>
                                    @endforelse
                                </ul>
                            </div>
                        </div>
